...
<body>
	<s:main radius="15" height="700" bgColor="rgba(255,255,255,0.7)"
		borderColor="#123456">
		<s:main width="330" height="300" margin="100px 0px 0px 30px"
			radius="10" bgColor="rgba(255,255,255,0.2)" topbg="#552288"
			borderColor="#552288">
			<form action="<s:home/>/loginservlet"
				style="margin: 32px 0px 0px 32px;" method="post">
				用户名：<input name="Name" type="text"
					style="margin-top: 5px; height: 30px; width: 200px;" /><br /> 密 码：<input
					name="Password" type="password"
					style="margin-top: 20px; height: 30px; width: 200px;" /><br /> 验证码：<input
					name="checkNum" type="text"
					style="margin-top: 20px; height: 30px; width: 60px;" maxlength="4" />
				<img src='<s:home/>/checkimg'
		...
		<s:main width="330" height="301" bgColor="rgba(255,255,255,0.2)"
			topbg="#552288" borderColor="#552288" radius="10"
			margin="-305px 30px 0px 0px" mCustomStyle="float:right;">
