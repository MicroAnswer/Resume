	...
	<div
		...
		<table cellspacing="0" width="720" align="center" border="1"
			...
			<tr>
                ...
                <td width="200" align="center"
					style="padding-top: 20px; padding-bottom: 20px; font-size: 25px;">
					<img src='<s:home/>/bg/java.jpg' width="100" height="135" border="1"
					style="margin-bottom: 10px;" /><br />Java程序设计
				</td>
                <td align="center" width="200" align="center" style="padding-top: 20px; padding-bottom: 20px; font-size: 20px;">
					<img src='<s:home/>/bg/android.jpg' width="100" height="135" border="1"
					style="margin-bottom: 10px;" /><br />Android手机软件开发
				</td>
			<tr>
			  <td align="center" align="center"
					style="padding-top: 20px; padding-bottom: 20px; font-size: 25px;">
					<img src='<s:home/>/bg/datamake.jpg' width="100" height="135" border="1"
					style="margin-bottom: 10px;" /><br />数据结构
				</td>
			  <td align="center" align="center"
					style="padding-top: 20px; padding-bottom: 20px; font-size: 25px;">
					<img src='<s:home/>/bg/javascript.png' width="100" height="135" border="1"
					style="margin-bottom: 10px;" /><br />JavaScript
				</td>
			  <td align="center" align="center"
					style="padding-top: 20px; padding-bottom: 20px; font-size: 25px;">
					<img src='<s:home/>/bg/html.jpg' width="100" height="135" border="1"
					style="margin-bottom: 10px;" /><br />Html
				</td>
	      <tr>
			    <td align="center" align="center"
					style="padding-top: 20px; padding-bottom: 20px; font-size: 25px;">
				...
				<td align="center" align="center"
					style="padding-top: 20px; padding-bottom: 20px; font-size: 25px;">
					<img src='<s:home/>/bg/Photoshop.jpg' width="100" height="135" border="1"
					style="margin-bottom: 10px;" /><br />PhotoShop
				</td>
				<td align="center" align="center"
					style="padding-top: 20px; padding-bottom: 20px; font-size: 25px;">
					<img src='<s:home/>/bg/apptest.png' width="100" height="135" border="1"
					style="margin-bottom: 10px;" /><br />软件测试
				</td>
	      <tr>
			...
			<tr>
			  <td colspan="4" class="tdd"><a href="http://www.jingkao.net/cert/jingkaocertificates/view?certId=hJ8VgSpNcuSyOaJCA2J">2015年Java甲骨文编程大赛西南赛区一等奖</a></td>
		  </tr>
			<tr>
